...
const CallToAction = () => {
  return (
    <section className="relative my-12 py-20 text-center bg-gradient-to-r from-[#16a34a] to-[#e7995e] text-white rounded-3xl shadow-lg mx-4 lg:mx-10 overflow-hidden">
      {/* Background Effects */}
